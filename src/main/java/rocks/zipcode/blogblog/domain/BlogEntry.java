...
public class BlogEntry implements Serializable {
    ...
    public void setTags(Set<BlogTag> blogTags) {
        this.tags = blogTags;
    }

    public BlogEntry tags(Set<BlogTag> blogTags) {
        this.setTags(blogTags);
        return this;
    }

    public BlogEntry addTag(BlogTag blogTag) {
        this.tags.add(blogTag);
        blogTag.getEntries().add(this);
        return this;
    }

    public BlogEntry removeTag(BlogTag blogTag) {
        this.tags.remove(blogTag);
        blogTag.getEntries().remove(this);
        return this;
    }
